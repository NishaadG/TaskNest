...
import { SIDE_MENU_USER_DATA,SIDE_MENU_DATA } from "../../utils/data";
...
const SideMenu = ({ activeMenu }) => {
  ...
  return <div className = "w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 sticky top-[61px] z-20">
          <div className="flex flex-col items-center justify-center  text-center mb-7 pt-5">
          ...
          <h5 className="text-gray-950 font-medium leading-6 ,t-3">{user?.name || ""}</h5>
